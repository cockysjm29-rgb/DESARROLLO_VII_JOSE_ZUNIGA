...
$misComidas = ["Pizza", "Hamburguesa", "Arroz con Pollo"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Lasaña", "Sushi", "Helado"]; // Reemplaza con las comidas favoritas de tu amigo
